...
export class HealthComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    helKeeper(values) {
        ...
        if (this.helapp.valid) {
            console.log(values,'sasdasd');
            const data = {
                'platform': 'web',
                'product_type': 'offline',
                'appointment_date': this.setDate,
                'appointment_time': this.helapp.controls['apptime'].value,
                'company_name': this.helapp.controls['name'].value,
                'customer_mobile': this.helapp.controls['mobile'].value,
                'customer_email': this.helapp.controls['email'].value,
                'contact_person' : this.helapp.controls['contactperson'].value,
                'pincode': this.helapp.controls['pincode'].value,
                'product_name': this.helapp.controls['insurance'].value,
                'appointment_with': this.helapp.controls['appointmentwith'].value,
