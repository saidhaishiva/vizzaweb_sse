...
// shriram Insurance
  ...
  getCoverPremium(data) {
    ...
    const url = this.configurationService.getBikeInsurance() + 'shriram/coverPremium';
    return this.http.post(url, json,httpOptions)
        .map(this.extractData)
        .catch(this.handleError);
  }
  ...
  getvoluntaryExcess(data) {
    ...
    const url = this.configurationService.getBikeInsurance() + 'shriram/voluntaryExcess';
    return this.http.post(url,json, httpOptions)
        .map(this.extractData)
        .catch(this.handleError);
  }
  ...
  getPAExclusionList(data) {
    const json = JSON.stringify(data);
    const token = this.authService.getAccessToken();
    const httpOptions = {
      headers: new HttpHeaders({'Content-Type': 'application/json', 'Access-Control-Allow-Origin': '*'})
    };
    const url = this.configurationService.getBikeInsurance() + 'common/PA_exclusion_list';
    return this.http.post(url,json, httpOptions)
        .map(this.extractData)
        .catch(this.handleError);
  }
  ...
  getCompanyName(data) {
    ...
    const url = this.configurationService.getBikeInsurance() + 'common/motorCompanyList';
    return this.http.post(url,json, httpOptions)
        .map(this.extractData)
        .catch(this.handleError);
  }
  getRegionList(data) {
    ...
    const url = this.configurationService.getBikeInsurance() + 'common/regionList';
    return this.http.post(url,json, httpOptions)
        .map(this.extractData)
        .catch(this.handleError);
  }
...
///GET occupation list
  ...
  coverPremium(data) {
    ...
    const url = this.configurationService.getBikeInsurance() + 'reliance/coverPremium';
    return this.http.post(url,json, httpOptions)
        .map(this.extractData)
        .catch(this.handleError);
...
// Tataaig pincodeList
  ...
  tataAddContent(data) {
    ...
    const url = this.configurationService.getBikeInsurance() + 'tata/addons_contents';
    return this.http.post(url,json, httpOptions)
        .map(this.extractData)
        .catch(this.handleError);
  }
...
//title
  ...
  hdfcCoverPremium(data) {
    const json = JSON.stringify(data);
    const token = this.authService.getAccessToken();
    const httpOptions = {
      headers: new HttpHeaders({'Content-Type': 'application/json', 'Access-Control-Allow-Origin': '*'})
    };
    const url = this.configurationService.getBikeInsurance() + 'hdfc/coverPremium';
    return this.http.post(url,json, httpOptions)
        .map(this.extractData)
        .catch(this.handleError);
  }
