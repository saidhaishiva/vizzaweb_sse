...
// bajaj gold surushka
    getUpdateDetails(data) {
     ...
     getPolicyTerm(data) {
        ...
        const url = this.configurationService.getmiscproduct() + 'bajaj/policy_term' ;
        return this.http.post(url, json, httpOptions)
            .map(this.extractData)
            .catch(this.handleError);
    }
     getPaymentTerm(data) {
        ...
        const url = this.configurationService.getmiscproduct() + 'bajaj/payment_term' ;
        return this.http.post(url, json, httpOptions)
            .map(this.extractData)
            .catch(this.handleError);
    }
    getPaymentFreq(data) {
        ...
        const url = this.configurationService.getmiscproduct() + 'bajaj/frequency' ;
        return this.http.post(url, json, httpOptions)
            .map(this.extractData)
            .catch(this.handleError);
    }
    ...
    mockLogin(data) {
        ...
        const url = this.configurationService.getHostHome() + 'mock/mock_profile';
        return this.http.post(url , json, httpOptions)
            .map(this.extractData )
            .catch(this.handleError);
    }
    mockQuestions(data) {
        ...
        const url = this.configurationService.getHostHome() + 'mock/mock_questions';
        return this.http.post(url , json, httpOptions)
            .map(this.extractData )
            .catch(this.handleError);
    }
    mockExamSubmit(data) {
        ...
        const url = this.configurationService.getHostHome() + 'mock/ans_request';
        return this.http.post(url , json, httpOptions)
            .map(this.extractData )
            .catch(this.handleError);
    }
