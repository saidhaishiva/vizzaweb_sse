...
export class LifeCallBackComponent implements OnInit {
  ...
  constructor(public dialogRef : MatDialogRef<LifeCallBackComponent>,
              @Inject(MAT_DIALOG_DATA)public auth:AuthService, public FromBuilder: FormBuilder,public fb: FormBuilder,public lifeservices:LifeService,public toastr :ToastrService) {
