...
@Component({
  ...
  templateUrl: './religare-download-pa-policy.component.html',
  styleUrls: ['./religare-download-pa-policy.component.scss']
})
export class ReligareDownloadPaPolicyComponent implements OnInit {
  ...
  DownloadPdf() {
    ...
    this.personalservice.downloadpolicyPdf(data).subscribe(
        (successData) => {
