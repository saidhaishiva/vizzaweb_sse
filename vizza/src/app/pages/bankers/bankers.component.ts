  ...
  ngOnInit() {
    ...
    public metaList() {
        const data = {
            ...
            'component_name': 'Bankers Identity Policy'
        };
    ...
    public metaDetailSuccess(successData) {
        ...
        this.metaTitle = this.metaBankers.title;
        this.metaKeyword = this.metaBankers.keyword;
        this.metaDescription = this.metaBankers.descrition;
