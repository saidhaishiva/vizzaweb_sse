  ...
  ngOnInit() {
    ...
    public metaList() {
        const data = {
            ...
            'component_name': 'Jewelers Block Policy'
        };
    ...
    public metaDetailSuccess(successData) {
        ...
        this.metaTitle = this.metaJewelersBlock.title;
        this.metaKeyword = this.metaJewelersBlock.keyword;
        this.metaDescription = this.metaJewelersBlock.descrition;
