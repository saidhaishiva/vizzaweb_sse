...
@Component({
  selector: 'app-employee-liability',
  templateUrl: './employee-liability.component.html',
  styleUrls: ['./employee-liability.component.scss'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ]
})
export class EmployeeLiabilityComponent implements OnInit {
