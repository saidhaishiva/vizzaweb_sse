...
export class LiftPolicyComponent implements OnInit {
  ...
  public metaList() {
    const data = {
      ...
      'component_name': 'Lift Insurance Policy'
    };
  ...
  public metaDetailSuccess(successData) {
    ...
    this.metaTitle = this.metaLift.title;
    this.metaKeyword = this.metaLift.keyword;
    this.metaDescription = this.metaLift.descrition;
