...
@Component({
  selector: 'app-career-liability-policy',
  templateUrl: './career-liability-policy.component.html',
  styleUrls: ['./career-liability-policy.component.scss'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ]
})
export class CareerLiabilityPolicyComponent implements OnInit {
  ...
  public webhost: any;
  public metaCareer: any;
  public metaTitle: any;
  metaKeyword: any;
  metaDescription: any;
  public settings: Settings;
  constructor(@Inject(WINDOW) private window: Window, public fb: FormBuilder, public commonservices: CommonService, public datepipe: DatePipe, public route: ActivatedRoute,public toastr: ToastrService,
  ...
  public metaList() {
    const data = {
      ...
      'component_name': ' Career Liability Policy'
    };
  ...
  public metaDetailSuccess(successData) {
    ...
    this.metaTitle = this.metaCareer.title;
    this.metaKeyword = this.metaCareer.keyword;
    this.metaDescription = this.metaCareer.descrition;
