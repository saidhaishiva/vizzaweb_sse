...
//  && (this.muscleDieaseInderror == false||this.muscleDieaseInderror=='')&&(this.smuscleDieaseInderror == false||this.smuscleDieaseInderror=='')&& (this.receivedTreatment2error == false||this.receivedTreatment2error=='')&&(this.sreceivedTreatment2error == false||this.sreceivedTreatment2error=='')&& (this.alcoholicInderror == false||this.alcoholicInderror=='')&& (this.salcoholicInderror == false||this.salcoholicInderror=='')&& (this.otherIllnessInderror == false||this.otherIllnessInderror=='')&&(this.sotherIllnessInderror == false||this.sotherIllnessInderror=='')&& (this.deformityInderror == false||this.deformityInderror=='')&&(this.sdeformityInderror == false||this.sdeformityInderror=='')&& (this.receivedTreatment1error == false||this.receivedTreatment1error=='')&&(this.sreceivedTreatment1error == false||this.sreceivedTreatment1error=='')&& (this.symptomsInderror == false||this.symptomsInderror=='')&&(this.ssymptomsInderror == false||this.ssymptomsInderror=='' ))) {
    ...
    insureHistorys(){
        if (this.insureArray.controls['insureHistory'].value=='Yes') {
            ...
            this.insureArray.controls['whenInsured'].patchValue(this.datepipe.transform(this.insureArray.controls['whenInsured'].value, 'y-MM-dd'));
    ...
    insureHistorys1(){
        if (this.insureArray.controls['sinsureHistory'].value=='Yes') {
            this.insureArray.controls['swhenInsured'].patchValue(this.datepipe.transform(this.insureArray.controls['swhenInsured'].value, 'y-MM-dd'));
    ...
    insureHistorys2(){
        if (this.insureArray.controls['sinsureHistory1'].value=='Yes') {
            this.insureArray.controls['swhenInsured1'].patchValue(this.datepipe.transform(this.insureArray.controls['swhenInsured1'].value, 'y-MM-dd'));
    ...
    insureHistorys21(){
        if (this.insureArray.controls['insureHistory1'].value=='Yes') {
            this.insureArray.controls['whenInsured1'].patchValue(this.datepipe.transform(this.insureArray.controls['whenInsured1'].value, 'y-MM-dd'));
...
//   }
    ...
    employmentTypereq1(){
        if (this.insureArray.controls['employementType'].value=='1'||this.insureArray.controls['employementType'].value=='7'||this.insureArray.controls['employementType'].value=='8'){
    ...
    semploymentTypereq1(){
        if (this.insureArray.controls['semployementType'].value=='1'||this.insureArray.controls['semployementType'].value=='7'||this.insureArray.controls['semployementType'].value=='8'){
        ...
        if (this.insureArray.controls['semployementType'].value=='5'){
            this.insureArray.controls['semployerName'].setValidators([Validators.required]);
            this.insureArray.controls['sdesignationorposition'].setValidators([Validators.required]);
            this.insureArray.controls['snatureduty'].setValidators([Validators.required]);
...
//   }
    ...
    othrhighQualify1(){
        if (this.insureArray.controls['highestQualification'].value=='1'||this.insureArray.controls['highestQualification'].value=='2'||this.insureArray.controls['highestQualification'].value=='3'||this.insureArray.controls['highestQualification'].value=='4'||this.insureArray.controls['highestQualification'].value=='5'||this.insureArray.controls['highestQualification'].value=='6'){
            this.insureArray.controls['lastcollegeorschool'].setValidators([Validators.required]);
            this.insureArray.controls['highesteducationorprof'].setValidators([Validators.required]);
    ...
    othrhighQualify2(){
        if (this.insureArray.controls['shighestQualification'].value=='1'||this.insureArray.controls['shighestQualification'].value=='2'||this.insureArray.controls['shighestQualification'].value=='3'||this.insureArray.controls['shighestQualification'].value=='4'||this.insureArray.controls['shighestQualification'].value=='5'||this.insureArray.controls['shighestQualification'].value=='6'){
            this.insureArray.controls['slastcollegeorschool'].setValidators([Validators.required]);
            this.insureArray.controls['shighesteducationorprof'].setValidators([Validators.required]);
    ...
    proposal(stepper) {
        ...
        const data = {
            ...
            "LifeAssured": {
                ...
                "insurance_history1":this.insureArray.controls['insureHistory1'].value ,
                "insurance_history1_name_of_insurer":this.insureArray.controls['companyName1'].value ,
                "insurance_history1_reason":this.insureArray.controls['reasonInsured1'].value ,
                "insurance_history1_when":this.datepipe.transform(this.insureArray.controls['whenInsured1'].value, 'y-MM-dd') ,
                "insurance_history2":this.insureArray.controls['insureHistory2'].value ,
                // "insurance_history3":this.insureArray.controls['existingInsuranceInd'].value ,
                ...
                "otherPolicy_Ind":this.insureArray.controls['insureHistory'].value=='Yes'?'Y':'N',
                "otherPolicy_InsurerName":"",
                "otherPolicy_OtherInsurerName":"",
                "otherPolicy_Reason":this.insureArray.controls['reasonInsured'].value ,
                "otherPolicy_Date":this.datepipe.transform(this.insureArray.controls['whenInsured'].value, 'y-MM-dd') ,
                "CIB_Ind":this.insureArray.controls['insureHistory1'].value=='Yes'?'Y':'N',
                "CIB_InsurerName":this.insureArray.controls['companyName1'].value,
                "CIB_Reason":this.insureArray.controls['reasonInsured1'].value,
                "CIB_Date":this.datepipe.transform(this.insureArray.controls['whenInsured1'].value, 'y-MM-dd'),
                ...
                "questionnaires":{
                    ...
                    "family_history": this.medicalDetail.controls['healthHistory'].value,
                    "family_history_details":this.medicalDetail.controls['healthHistoryDetail'].value,
                    "family_history1": this.medicalDetail.controls['healthHistory1'].value,
            ...
            "Proposer":{
                ...
                "employementTypeOther":'',
                "employerName":this.insureArray.controls['semployerName'].value,
                "employerAddr":this.insureArray.controls['semployerAddr'].value,
                ...
                "insurance_history":this.insureArray.controls['sinsureHistory'].value ,
                "insurance_history_reason":this.insureArray.controls['sreasonInsured'].value ,
                "insurance_history_when":this.datepipe.transform(this.insureArray.controls['swhenInsured'].value, 'y-MM-dd') ,
                "insurance_history1":this.insureArray.controls['sinsureHistory1'].value ,
                "insurance_history1_name_of_insurer":this.insureArray.controls['scompanyName1'].value ,
                "insurance_history1_reason":this.insureArray.controls['sreasonInsured1'].value ,
                ...
                "familyDiease_Details":"",
                "hasfamilyAppliedETLI":"",
                "otherPolicy_Ind":this.insureArray.controls['sinsureHistory'].value=='Yes'?'Y':'N',
                "otherPolicy_InsurerName":"",
                "otherPolicy_OtherInsurerName":"",
                "otherPolicy_Reason":this.insureArray.controls['sreasonInsured'].value ,
                "otherPolicy_Date":this.datepipe.transform(this.insureArray.controls['swhenInsured'].value, 'y-MM-dd') ,
                "CIB_Ind":this.insureArray.controls['sinsureHistory1'].value=='Yes'?'Y':'N',
                "CIB_InsurerName":this.insureArray.controls['scompanyName1'].value,
                "CIB_Reason":this.insureArray.controls['sreasonInsured1'].value,
                "CIB_Date":this.datepipe.transform(this.insureArray.controls['swhenInsured1'].value, 'y-MM-dd'),
                "isPEP":"",
                "pepReason":"",
                "hasFamPhysician":"",
                "FamPhysicianName":"",
                ...
                "questionnaires":{
                    ...
                    "family_history": this.medicalDetail.controls['shealthHistory'].value,
                    "family_history_details":this.medicalDetail.controls['shealthHistoryDetail'].value,
                    "family_history1": this.medicalDetail.controls['shealthHistory1'].value,
                },
                "bank":{
                    "accountNo":"",
                    "name":"",
...
// Services
    ...
    sessionData() {
        ...
        if (sessionStorage.stepper2Details != '' && sessionStorage.stepper2Details != undefined) {
            ...
            this.insureArray.controls['correspondenceAddress'].patchValue(this.getStepper2.correspondenceAddress);
