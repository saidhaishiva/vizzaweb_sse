...
@Component({
  selector: 'app-view-keyfeatures',
  templateUrl: './view-keyfeatures.component.html',
  styleUrls: ['./view-keyfeatures.component.scss']
})
export class ViewKeyfeaturesComponent implements OnInit {
  webhost: any;
  compareDetails: any;
  keyFeatureNames: any;
  id : any;
