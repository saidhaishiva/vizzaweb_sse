...
@Component({
    ...
    templateUrl: './download-policy-travel.component.html',
    styleUrls: ['./download-policy-travel.component.scss']
})
export class DownloadPolicyTravelComponent implements OnInit {
