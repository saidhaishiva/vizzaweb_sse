...
export class MarinecargoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    public metaDetailSuccess(successData) {
        this.metaMarineCargo = successData.ResponseObject[0];
        this.metaTitle = this.metaMarineCargo.title;
        this.metaKeyword = this.metaMarineCargo.keyword;
        this.metaDescription = this.metaMarineCargo.descrition;
