...
@Component({
  selector: 'app-contractor-machinery-policy',
  templateUrl: './contractor-machinery-policy.component.html',
  styleUrls: ['./contractor-machinery-policy.component.scss'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ]
})
export class ContractorMachineryPolicyComponent implements OnInit {
  ...
  public webhost: any;
  public metaContractorMachinery: any;
  ...
  public metaList() {
    const data = {
      ...
      'component_name': 'contractor-machinery-policy'
    };
  ...
  public metaDetailSuccess(successData) {
    ...
    this.metaContractorMachinery = successData.ResponseObject[0];
    this.metaTitle = this.metaContractorMachinery.title;
    this.metaKeyword = this.metaContractorMachinery.keyword;
    this.metaDescription = this.metaContractorMachinery.descrition;
