...
export class DirectorsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    dirKeeper(values) {
        ...
        if (this.dirapp.valid) {
            const data = {
                'platform': 'web',
                'product_type': 'offline',
                'appointment_date': this.setDate,
                'appointment_time': this.dirapp.controls['apptime'].value,
                'company_name': this.dirapp.controls['name'].value,
                'customer_mobile': this.dirapp.controls['mobile'].value,
                'customer_email': this.dirapp.controls['email'].value,
                'contact_person' : this.dirapp.controls['contactperson'].value,
                'pincode': this.dirapp.controls['pincode'].value,
                'product_name': this.dirapp.controls['insurance'].value,
                'appointment_with': this.dirapp.controls['appointmentwith'].value,
