...
export class ProfessionalIndemnityPolicyComponent implements OnInit {
  ...
  public metaList() {
    const data = {
      ...
      'component_name': 'Professional Indemnity Policy'
    };
  ...
  public metaDetailSuccess(successData) {
    ...
    this.metaTitle = this.metaProf.title;
    this.metaKeyword = this.metaProf.keyword;
    this.metaDescription = this.metaProf.descrition;
