...
@Component({
  selector: 'app-professional-indemnity-policy',
  templateUrl: './professional-indemnity-policy.component.html',
  styleUrls: ['./professional-indemnity-policy.component.scss'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ]
})
export class ProfessionalIndemnityPolicyComponent implements OnInit {
