...
export class MarineErectionComponent implements OnInit {
  ...
  public metaList() {
    const data = {
      ...
      'component_name': ' Marine Erection Policy'
    };
  ...
  public metaDetailSuccess(successData) {
    ...
    this.metaTitle = this.metaMarine.title;
    this.metaKeyword = this.metaMarine.keyword;
    this.metaDescription = this.metaMarine.descrition;
