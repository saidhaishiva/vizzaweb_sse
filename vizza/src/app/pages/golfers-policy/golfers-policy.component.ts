...
export class GolfersPolicyComponent implements OnInit {
  ...
  public metaDetailSuccess(successData) {
    ...
    this.metaTitle = this.metaGolfers.title;
    this.metaKeyword = this.metaGolfers.keyword;
    this.metaDescription = this.metaGolfers.descrition;
