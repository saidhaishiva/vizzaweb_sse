...
@Component({
  selector: 'app-golfers-policy',
  templateUrl: './golfers-policy.component.html',
  styleUrls: ['./golfers-policy.component.scss'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ]
})
export class GolfersPolicyComponent implements OnInit {
