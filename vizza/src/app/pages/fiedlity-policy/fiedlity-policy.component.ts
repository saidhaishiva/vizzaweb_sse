...
export class FiedlityPolicyComponent implements OnInit {
  ...
  public metaList() {
    const data = {
      ...
      'component_name': 'Fiedlity Policy'
    };
  ...
  public metaDetailSuccess(successData) {
    ...
    this.metaTitle = this.metaFiedility.title;
    this.metaKeyword = this.metaFiedility.keyword;
    this.metaDescription = this.metaFiedility.descrition;
