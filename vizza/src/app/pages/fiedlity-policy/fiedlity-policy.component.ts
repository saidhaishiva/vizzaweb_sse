...
@Component({
  selector: 'app-fiedlity-policy',
  templateUrl: './fiedlity-policy.component.html',
  styleUrls: ['./fiedlity-policy.component.scss'],
  providers: [
    {provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE]},
    {provide: MAT_DATE_FORMATS, useValue: MY_FORMATS},
  ]
})
export class FiedlityPolicyComponent implements OnInit {
