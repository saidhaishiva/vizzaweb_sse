...
export const routes: Routes = [
...

    {
        ...
        component: PagesComponent, children: [
            ...
            { path: 'religare-travel/:proposalId/:stepper', component: ReliagretravelproposalComponent, data:{breadcrumb: 'Religare Travel Proposal'}},
            { path: 'reliancetravel/:stepper', component: TravelRelianceProposalComponent, data:{breadcrumb: 'Reliance Travel Proposal'}},
            { path: 'reliance-travel/:proposalId/:stepper', component: TravelRelianceProposalComponent, data:{breadcrumb: 'Reliance Travel Proposal'}},
            ...
            { path: 'hdfc-health-payment-success/:status/:proId/:policyNo/:policyStatus', component: HdfcHealthPaymentSuccessComponent, data:{breadcrumb: 'Payment Success'}},
            ...
            { path: 'hdfctravel/:proposalId/:stepper', component: TravelHdfcProposalComponent, data:{breadcrumb: 'HDFC Travel'}, canDeactivate: [TravelhdfcdeactivateGuardService]},
            ...
            { path: 'bajaj-travelProposal/:proposalId/:stepper', component: TravelBajajalianzProposalComponent, data:{ breadcrumb: 'Travel Bajajalianz '}},
            { path: 'chola-health-proposal/:stepper', component: CholaHealthProposalComponent, data:{ breadcrumb: 'Chola Health'}},
            { path: 'chola-proposal/:proposalId/:stepper', component: CholaHealthProposalComponent, data:{ breadcrumb: 'Chola Health'}},
