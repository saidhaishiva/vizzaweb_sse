...
export const routes: Routes = [
    { path: '', redirectTo: 'home', pathMatch: 'full' },
    {
        ...
        component: PagesComponent, children: [
            ...
            { path: 'bike-tataaig-payment-success/:status/:proId/:policyNo', component: BikeTataaigPaymentSuccesssComponent, data:{ breadcrumb: 'bikeTataaig Payment'} },
            ...
            { path: 'car-tataaig-payment-success/:status/:proId/:policyNo', component: CarTataaigPaymentSuccessComponent, data: { breadcrumb: 'carTataaig payment'} },
