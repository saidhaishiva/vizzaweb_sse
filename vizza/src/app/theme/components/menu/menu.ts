...
export const horizontalMenuItems = [ 
    ...
    new Menu (8, 'Personal Accident', '/fix-appointment/personal', null, null, null, true, 2),
    new Menu (9, 'Offline Insurance', '/fix-appointment/offline', null, null, null, true, 0),
    new Menu (10, 'Shopkeepers Policy', '/fix-appointment/shopkeepers', null, null, null, false, 9),
    new Menu (11, 'Marine Cargo Policy', '/fix-appointment/marine', null, null, null, false, 9),
    new Menu (12, 'Money Insurance', '/fix-appointment/money', null, null, null, false, 9),
    new Menu (13, 'Fire Policy', '/fix-appointment/fire', null, null, null, false, 9),
    new Menu (14, 'Burglary Policy', '/fix-appointment/burglary', null, null, null, false, 9),
    new Menu (15, 'Machinery Breakdown Policy', '/fix-appointment/machinery', null, null, null, false, 9),
    new Menu (16, 'Electronics Equipment Policy', '/fix-appointment/electronics', null, null, null, false, 9),
    new Menu (17, 'Contractors All Risk Policy', '/fix-appointment/contractors', null, null, null, false, 9),
    new Menu (18, 'House Holders Policy', '/fix-appointment/house-holders', null, null, null, false, 9),
    new Menu (19, 'Public Liability Policy', '/fix-appointment/public-liability', null, null, null, false, 9),
    new Menu (20, 'Professional Indemnity Policy', '/fix-appointment/professional', null, null, null, false, 9),
    new Menu (21, 'Workmen Compensation', '/fix-appointment/workmen-compensation', null, null, null, false, 9),
    new Menu (22, 'Corporate Insurance', '/fix-appointment/corporate-insurance', null, null, null, true, 0),
    new Menu (23, 'Group Medical Insurance', '/fix-appointment/group-medical-insurance', null, null, null, false, 22),
    new Menu (24, 'Group Personal Accident', '/fix-appointment/group-personal-accident', null, null, null, false, 22),
    new Menu (25, 'Group Term Life Insurance', '/fix-appointment/group-term-life', null, null, null, false, 22),
    new Menu (26, 'Jewelers Block Policy', '/fix-appointment/jewelers-block', null, null, null, false, 22),
    new Menu (27, 'Bankers Identity Policy', '/fix-appointment/bankers-identity', null, null, null, false, 22),
    new Menu (28, 'Marine Hull policy', '/fix-appointment/marine-hull', null, null, null, false, 22),
    new Menu (29, 'Aviation Insurance', '/fix-appointment/aviation-insurance', null, null, null, false, 22),
    new Menu (30, 'Erection All rick Policy', '/fix-appointment/erection-all', null, null, null, false, 22),
    new Menu (31, 'Directors and Officers Liability Policy', '/fix-appointment/directors', null, null, null, false, 22),
    new Menu (32, 'Media', '/fix-appointment/media', null, null, null, false, 0),
