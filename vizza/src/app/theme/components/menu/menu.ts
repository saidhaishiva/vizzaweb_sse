...
export const horizontalMenuItems = [ 
    ...
    // new Menu (4, 'Health Form', '/health', null, null, null, true, 2),
    ...
    new Menu (8, 'Travel', '/travel', null, null, null, true, 2),
    new Menu (9, 'Personal Accident', '/personalaccident', null, null, null, true, 2),
    new Menu (10, 'Offline Insurance', '/fix-appointment/offline', null, null, null, true, 0),
    ...
    new Menu (22, 'Workmen Compensation', '/workmen', null, null, null, false, 9),
    new Menu (23, 'Corporate Insurance', '/fix-appointment/corporate-insurance', null, null, null, true, 0),
