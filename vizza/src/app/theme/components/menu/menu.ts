...
export const horizontalMenuItems = [
    ...
    new Menu (6, 'Motor Car Insurance', '/car-insurance', null, null, null, true, 2),
    new Menu (7, 'Motor Bike Insurance', '/bike-insurance', null, null, null, true, 2),
    new Menu (3, 'Health Insurance', '/healthinsurance', null, null, null, true, 2),
    new Menu (10, 'Personal Accident', '/personalaccident', null, null, null, true, 2),
    new Menu (8, 'Travel Insurance', '/travel', null, null, null, true, 2),
    ...
    new Menu (4, 'Life Insurance-Term', '/term-life-insurance', null, null, null, false, 9),
    ...
    new Menu (31, 'Special Contingency Policy', '/', null, null, null, false, 24),
    new Menu (32, 'Marine Hull Policy', '/', null, null, null, false, 24),
    new Menu (33, 'Aviation Insurance', '/', null, null, null, false, 24),
    ...
    new Menu (34, 'Consequential Loss Policy', '/', null, null, null, false, 25),
    new Menu (18, 'Contractors All Risk Policy', '/contractors', null, null, null, false, 25),
    new Menu (35, 'Marine cum Erection/ Storage Policy', '/', null, null, null, false, 25),
    new Menu (36, 'Advance Loss of Profit', '/', null, null, null, false, 25),
    new Menu (37, 'Contractor Plant and Machinery Policy', '/', null, null, null, false, 25),
    new Menu (38, 'Mega Package Policy', '/', null, null, null, false, 25),
    new Menu (39, 'Erection All Risk Policy', '/', null, null, null, false, 25),
    ...
    new Menu (46, 'Liability Insurance Act Policy', '/', null, null, null, false, 26),
    new Menu (47, 'Golfers Indemnity Policy', '/', null, null, null, false, 26),
    new Menu (48, 'Fidelity Guarantee Insurance Policy', '/', null, null, null, false, 26),
    new Menu (27, 'Group Insurance', '/', null, null, null, true, 22),
    new Menu (49, 'Group Medical Insurance', '/', null, null, null, false, 27),
    ...
    new Menu (52, 'Group Travel Insurance', '/', null, null, null, false, 27),
