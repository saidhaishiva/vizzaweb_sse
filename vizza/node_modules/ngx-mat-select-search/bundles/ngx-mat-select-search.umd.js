(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/forms'), require('@angular/cdk/keycodes'), require('@angular/cdk/scrolling'), require('rxjs'), require('rxjs/operators'), require('@angular/core'), require('@angular/material'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-mat-select-search', ['exports', '@angular/forms', '@angular/cdk/keycodes', '@angular/cdk/scrolling', 'rxjs', 'rxjs/operators', '@angular/core', '@angular/material', '@angular/common'], factory) :
    (factory((global['ngx-mat-select-search'] = {}),global.ng.forms,global.ng.cdk.keycodes,global.ng.cdk.scrolling,global.rxjs,global.rxjs.operators,global.ng.core,global.ng.material,global.ng.common));
}(this, (function (exports,forms,keycodes,scrolling,rxjs,operators,core,material,common) { 'use strict';
    ...
    var MatSelectSearchComponent = /** @class */ (function () {
        ...
        MatSelectSearchComponent.propDecorators = {
            ...
            showToggleAllCheckbox: [{ type: core.Input }],
            toggleAllCheckboxChecked: [{ type: core.Input }],
            toggleAllCheckboxIndeterminate: [{ type: core.Input }],
            toggleAll: [{ type: core.Output }],
