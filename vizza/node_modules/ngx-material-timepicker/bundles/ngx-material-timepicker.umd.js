(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('moment'), require('@angular/animations'), require('rxjs/operators'), require('@angular/platform-browser'), require('@angular/forms'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs', 'moment', '@angular/animations', 'rxjs/operators', '@angular/platform-browser', '@angular/forms', '@angular/common'], factory) :
	(factory((global['ngx-material-timepicker'] = {}),global.ng.core,global.rxjs,global.moment,global.ng.animations,global.Rx.Observable.prototype,global.ng.platformBrowser,global.ng.forms,global.ng.common));
}(this, (function (exports,core,rxjs,moment,animations,operators,platformBrowser,forms,common) { 'use strict';
...
exports.ɵg = NgxMaterialTimepickerHoursFaceComponent;
exports.ɵh = NgxMaterialTimepickerMinutesFaceComponent;
exports.ɵm = FocusAnchorDirective;
exports.ɵe = TimepickerDirective;
exports.ɵl = OverlayDirective;
exports.ɵa = AnimationState;
exports.ɵb = NgxMaterialTimepickerComponent;
exports.ɵf = StyleSanitizerPipe;
