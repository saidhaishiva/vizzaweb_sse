...
export const verticalMenuItems = [
    ...
    new Menu (1, 'POS List', '/pos', null, 'supervisor_account', null, false, 0),
    new Menu (2, 'Add POS', '/addpos', null, 'supervisor_account', null, false, 0),
    // new Menu (2, 'Qualification', '/qualification', null, 'supervisor_account', null, false, 0),
    // new Menu (3, 'Masters', '/masters', null, 'dashboard', null, false, 0),
    // new Menu (4, 'Me & MyFamily', '/users', null, 'supervisor_account', null, false, 0),
    // new Menu (5, 'Appoinments', '/appoinments', null, 'library_books', null, false, 0),
    // new Menu (6, 'Answered Queries', '/answered-queries', null, 'chat', null, false, 0),
    // new Menu (7, 'Lab Order', '/lab-order', null, 'content_paste', null, false, 0),
    ...
    new Menu (11, 'Learning Center', '/learning-center', null, 'assignment_late', null, true, 0),
    ...
    new Menu (14, 'Questions', '/question', null, 'assignment_late', null, false, 11),
    new Menu (15, 'Contact ', '/contact-us', null, 'phone', null, false, 0),
    new Menu (16, 'Logout', '/login', null, 'power_settings_new', null, false, 0 ),
]

    // new Menu (1, 'New Orders', '/neworders', null, 'work', null, false, 0),
...
export const horizontalMenuItems = [ 
    //new Menu (0, 'Dashboard', '/', null, 'dashboard', null, false, 0),
    // new Menu (1, 'New Orders', '/neworders', null, 'work', null, false, 0),
