...
@Component({
  selector: 'app-posmanager',
  templateUrl: './posmanager.component.html',
  styleUrls: ['./posmanager.component.scss']
})
export class PosmanagerComponent implements OnInit {
    public webhost: any;
    public data: any;
    ...
    public posManagerList() {
        ...
        this.branchservice.posManagerList(data).subscribe(
            (successData) => {
